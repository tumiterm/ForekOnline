...
namespace ElecPOE.Controllers
{
    ...
    public class LessonPlanController : Controller
    {
        ...
        public LessonPlanController(IUnitOfWork<LessonPlan> context,
            ...
            if (plan != null)
            {
                if (ModelState.IsValid)
                {
                    ...
                    if (lPlan != null)
                    {
                        ...
                        if (rc > 0)
                        {
                            _notify.Success("Lesson plan saved successfully", 5);
                            ...
                            return RedirectToAction("OnCreatePlan", "LessonPlan", new { IdPass = lPlan.IdPass });
                        }
                        else
                        {
                            _notify.Error("Error: Unable to save Lesson Plan!!!", 5);
                        }
                    }
                    else
                    {
        ...
        [HttpGet]
        public async Task<IActionResult> OnModifyPlan(Guid LessonPlanId)
        {
        ...
        public async Task<IActionResult> OnModifyPlan(LessonPlanDTO model)
        {
            LessonPlan plan = new LessonPlan();
            ...
            if (plan != null)
            {
                ...
                if (obj != null)
                {
                    _notify.Success("Lesson Plan successfully saved", 5);
                    ...
                    return RedirectToAction("OnCreatePlan", "LessonPlan", new { IdPass = plan.IdPass });
